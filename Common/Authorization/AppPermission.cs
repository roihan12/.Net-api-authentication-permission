...
namespace Common.Authorization
{
    ...
    public class AppPermissions
    {
        private static readonly AppPermission[] _all = new AppPermission[]
        {
            ...
            new(AppFeature.RolesClaims, AppAction.Update, AppRoleGroup.SystemAccess, "Update Roles Claims/Permissions"),
            new(AppFeature.RolesClaims, AppAction.Read, AppRoleGroup.SystemAccess, "Read Roles Claims/Permissions"),
        ...
        public static IReadOnlyList<AppPermission> AdminPermissions { get; } = new ReadOnlyCollection<AppPermission>(_all.Where(ap => !ap.IsBasic).ToArray());
